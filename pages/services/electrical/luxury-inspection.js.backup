...
export default function LuxuryInspection() {
  return (
    <Layout
      title="Luxury Electrical Inspection - $225 | MetroPlex Pros Dallas"
      description="Premium electrical inspection for luxury homes and estates. Includes thermal imaging, smart home systems, and priority service. Expert electricians. Book online!"
      keywords="luxury electrical inspection, premium home inspection Dallas, smart home inspection, estate electrical assessment"
    >
      {/* Hero Section */}
      <section style={{
        ...
        <div className="container">
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <p style={{
              ...
              Our premium service for luxury homes, estates, and properties with advanced smart home systems. Unlimited square footage with white-glove service.
            </p>
